    ...
    public LoginView(LoginController controller) {
        ...
        root.setStyle(
                "-fx-background-color: #000000; " +
                        ...
                        "-fx-background-size: contain; " + // Changed from 'cover' to 'contain' to show complete image
        ...
        circleContainer.setMaxSize(350, 350); // Fixed size for circle

        // Circular styling with black background and border
        circleContainer.setStyle(
                "-fx-background-color: #000000; " +
                        "-fx-background-radius: 175; " + // Makes it circular
                        "-fx-border-color: #135A0E; " +
                        "-fx-border-width: 3px; " +
                        "-fx-border-radius: 175; " // Makes border circular
        );
